...
echo " "
echo " export PKG_PATH=http://openbsd.c3sl.ufpr.br/pub/OpenBSD/`uname -r`/packages/`arch -s`/ " >> /root/.profile
echo " export PKG_PATH=http://openbsd.c3sl.ufpr.br/pub/OpenBSD/`uname -r`/packages/`arch -s`/ ">> /home/vagrant/.profile

# install wget/curl/bash/vim and its dependencies
echo " "
echo " Installing needed packages "
echo " "
export PKG_PATH=http://openbsd.c3sl.ufpr.br/pub/OpenBSD/`uname -r`/packages/`arch -s`/
...
echo " "
cd /tmp
wget http://openbsd.c3sl.ufpr.br/pub/OpenBSD/`uname -r`/ports.tar.gz
cd /usr
